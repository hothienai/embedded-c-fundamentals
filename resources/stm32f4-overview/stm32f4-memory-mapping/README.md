...
:dart: Hello everyone, in this article I will let you know some important memory sections in the memory of microcontroller. By knowing where the memory section is located and what the purpose of it is, helping you become a skillfull engineer that can understand the new project quickly, easily debug a software, able to develop and design a roburstness software.

What are the motivations of this article? These are coming from my experience during working and interview. Can you answer the below questions?
* What is the size of RAM, ROM the microcontroller has? Does the mircrocontroller have enough resource to develop the embedded system you want?
* Where are the different kind of varibles stored in the program?
* Where is program code stored?
* Where is non-volatile data stored?
* I would like to use one peripheral to do one function. How to configure the peripheral to this function?
* Sometimes the program is crashed, does it access memory location that it should not?
* Is the mirocontroller running out of the resource when it is running and cause the critical problem.
* Can we set up a critical mechenism to proctect the memory from unwanted access? 
...
<p align="center">
  <a href="." title="Central Processing Unit">
    <img src="/resources/uc-architecture/images/8051_architecture_cpu.jpg" title="Central Processing Unit" style="width: 50vw; min-width: 200px"/>
  </a>
</p>
...
<p align="center">
  <a href="." title="IO Ports">
    <img src="/resources/uc-architecture/images/8051_architecture_io.jpg" title="IO Ports" style="width: 50vw; min-width: 200px"/>
  </a>
</p>
