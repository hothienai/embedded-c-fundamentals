...
[Embedded C Fundamentals](https://github.com/Sigma-eLabs/Embedded-C-Fundamentals) is focusing on helping you get familiar with embedded programming world step-by-step.

By having the fudamental knowledge about the embedded C, will enable you to have below skills:
...
The topics may be simple, but I believe that every topic I bring here is a step-stone enable you to approach the much higher complex technical topics in embedded programming world and help you develop your career path!
...
## Hardware
Development Kits used in the most of topics:
